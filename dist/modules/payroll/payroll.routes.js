...
const router = Router();
router.get("/:id/slip", requireAuth, requirePermission("payroll:export"), asyncHandler(async (req, res) => {
    const payroll = (await Payroll.findById(req.params.id).populate("employeeId", "firstName lastName employeeCode").lean());
